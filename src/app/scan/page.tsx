...
export default function ScanPage() {
  ...
  // scan and points/coins are awarded only after the student scans a staff QR.
  ...
  const submit = useCallback(async (blob: Blob, scanId: string) => {
    ...
    try {
      ...
      setResult(res);
      setState("result");
      // enforce mode: points/coins await a staff-QR confirm.
  ...
  if (state === "result" && result)
    return (
      ...
      >
        ...
        {(() => {
          // enforce mode: points/coins pending until a staff QR confirms them.
        ...
        {!result.preview && approverPrompt && approverStatus !== "confirmed" && approverStatus !== "expired" && (
          <div style={{
            ...
            borderRadius: 16, padding: 16, marginTop: 16, width: "100%", maxWidth: 360, textAlign: "center",
          }}>
            ...
            <button
              ...
              style={{
                background: "white", color: t.forest, border: "none",
        ...
        {!result.preview && approverStatus === "confirmed" && (
          <div style={{
            background: "rgba(255,255,255,0.2)", borderRadius: 12, padding: 10, marginTop: 12,
        ...
        {approverStatus === "expired" && (
          <div style={{
            background: "rgba(255,200,0,0.18)", borderRadius: 12, padding: 10, marginTop: 12,
